...
private int m_no, m_gender, m_grade, m_ph, count, fcount, f2count;
...
private String m_id, m_pw, m_name, m_addr, m_em, m_birth, m_intro;
...
public String getM_em() {
	return m_em;
}
public void setM_em(String m_em) {
	this.m_em = m_em;
}
